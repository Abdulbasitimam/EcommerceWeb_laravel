...
class HomeController extends Controller
{
    ...
    {
    $product = Product::all(); // Fix variable name capitalization
    $count = ''; // Default count for unauthenticated users
...
<<<<<<< HEAD
    {
        ...
        // Search products by name (adjust this to fit your database structure)
